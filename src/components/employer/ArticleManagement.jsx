    ...
    <div className="article-management-section">
      <div className="section-header">
        ...
        <div className="btn-group">
          <button className="primary-btn" onClick={() => navigate('/create-article')}>
            <FaEdit /> New Article
          </button>
            ...
            {articles.map(article => (
              <tr key={article._id}>
                ...
                <td className="actions">
                  <div className="btn-group">
                    <button className="btn-warning" onClick={() => navigate(`/edit-article/${article._id}`)}>
                      <FaEdit /> Edit
                    </button>
                    <button className="btn-danger" onClick={() => handleDeleteArticle(article._id)}>
                      <FaTrash /> Delete
                    </button>
                  </div>
                </td>
