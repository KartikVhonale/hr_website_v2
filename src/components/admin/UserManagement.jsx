...
import { FaEdit, FaTrash, FaKey, FaSearch } from 'react-icons/fa';

const UserManagement = ({ users, handleEditUser, handleDeleteUser, handleResetPassword }) => {
            ...
            {filteredUsers.map(user => (
              <tr key={user._id}>
                ...
                <td className="actions">
                  <Button size="sm" onClick={() => handleEditUser(user)}><FaEdit /> Edit</Button>
                  <Button size="sm" variant="destructive" onClick={() => handleDeleteUser(user._id)}><FaTrash /> Delete</Button>
                  <Button size="sm" variant="secondary" onClick={() => handleResetPassword(user._id)}><FaKey /> Reset</Button>
                </td>
              </tr>
            ))}
          </tbody>
